...
splash_damage_options = {
    ...
    ["allunits_advanced_effect_sequence_chance"] = 0.1, --Chance of the script picking the advanced effect instead of the standard all unit effect. 1 = 100%, 0.5 = 50%
    ...
    ---------------------------------------------------------------------- Kill Feed  ------------------------------------------------------------------------
    ["killfeed_enable"] = true, --Enable killfeed logging and messaging
    ["killfeed_game_messages"] = true, --Show killfeed SPLASH KILL FEED WORKS IN MP ONLY (you can host your local SP mission as MP for now)
    ...
    ["tactical_explosion_override_weapons"] = "BGM_109B", --Comma-separated list of weapons to override as tactical explosion, can be changed as needed.  Needs to be enabled in the key above.
    ...
    ["tactical_explosion_central_power"] = 600, --Power of central explosion
    ["tactical_explosion_explosion_power"] = 400, --Base power for secondary explosions
    ["tactical_explosion_explosion_count_min"] = 10, --Min number of secondary explosions
